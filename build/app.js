...
var CookieStore = (0, _connectMongo["default"])(_expressSession["default"]); // 보안

app.use((0, _helmet["default"])({
  contentSecurityPolicy: false
})); // html

app.set("view engine", "pug"); // directory에서 file을 보내주는 middleware

app.use("/uploads", _express["default"]["static"]("uploads"));
app.use("/static", _express["default"]["static"]("static")); // 서버에서 읽을 수 있게 parse
